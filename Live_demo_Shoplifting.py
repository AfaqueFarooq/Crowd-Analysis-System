...
from apps.firebasee import insert_shoplifting
import Alert
...
def Pred():
    ...
    with lock:
        ...
        reports = shoplifting_SYS.run_ShopLifting_frames_check(Frame_set, Frame_INDEX)
        #print(reports)
        ...
        if (state):
            ...
            found_fall_video_path = shoplifting_SYS.save_frame_set_after_pred_live_demo(src_main_dir_path,
                                                                                 ...
                                                                                 Frame_INDEX-1, prob,
                                                                                0, W, H)
            insert_shoplifting(Bag, Clotes, Normal)   
            return Bag, Clotes, Normal
